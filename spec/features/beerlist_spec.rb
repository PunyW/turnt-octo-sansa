...
describe 'Beerlist page' do
  ...
  it 'by default ordered by name', js:true do
    visit beerlist_path
  ...
  it 'when clicking style beers are ordered according to style name', js:true do
    visit beerlist_path
  ...
  it 'when clicking brewery beers are ordered according to brewery name', js:true do
    visit beerlist_path
